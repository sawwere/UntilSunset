...
public class BuildHelp : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (b)
        {
            ...
            dialogBox3.transform.GetChild(0).gameObject.GetComponent<TextMeshProUGUI>().text = "Если враг все-таки добрался до дома,то у дом будет терять здоровье, которое находится" +
                " в правом верхнем углу. Вы можете пополнить здоровье, починив гроб. Для этого нажмите на него";
